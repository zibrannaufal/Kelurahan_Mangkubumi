    ...
    <div class="row align-items-center" style="width: 100%">
        ...
        <div class="col-md-6">
            <div class="align-self-center">
                <img style="width: 530px; height:auto;" src="images/history.png">
            </div><br><br>
        </div>
    </div>
</div>
...
<div class="container mx-3">
    <h4 class="text-center" style="color: #244CFF"><b>Visi & Misi</b></h4>
    <p class="text-center" style="color: #244CFF">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam obcaecati dolores ut ipsa.</p>
        ...
        <div class="row">
            <div class="col-md-auto mx-auto">
                <div class="card p-5" style="width: 20rem; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2); border-radius: 20px;">
                    <img src="images/misi_1.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <p class="card-text" style="text-align: justify; color: #244CFF">Lorem ipsum dolor sit amet amet consectetur adipisicing elit.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-auto mx-auto">
